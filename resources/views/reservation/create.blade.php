					...
					<div class="col-xl-12 col-xxl-12 col-sm-12">
                        <div class="card">
                            <div class="card-header">
								<h5 class="card-title">Registro de novo Aluno</h5>
							</div>
							...
							<div class="card-body">
                                <form action="{{route('reservation.store')}}" method="post">
									...
									<div class="row">
										...
										<div class="col-lg-6 col-md-6 col-sm-12">
											<div class="form-group">
												<label class="form-label">Data de Nasciemto</label>
										...
										<div class="col-lg-6 col-md-6 col-sm-12">
											<div class="form-group">
												...
												<input name="email" name="email"class="form-control" value="{{old('email')}}">
											</div>
										</div>
										<div class="col-lg-6 col-md-6 col-sm-12">
											<div class="form-group">
												<label class="form-label">Telefone de Emergencia</label>
												<input type="text" name="nr_emergencia" class="form-control">
											</div>
										</div>
										<div class="col-lg-6 col-md-6 col-sm-12">
											<div class="form-group">
